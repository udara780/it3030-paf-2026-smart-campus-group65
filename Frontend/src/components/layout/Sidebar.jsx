...
import { HiHome, HiTicket, HiBell, HiX } from 'react-icons/hi';
...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 h-full w-72 bg-dark-card/95 backdrop-blur-sm border-r border-dark-border/50 z-50 transform transition-transform duration-300 ease-in-out
